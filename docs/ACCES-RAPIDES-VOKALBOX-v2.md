...
## 🔐 Login Admin Universel
**Login :** jack06210
**Mot de passe :** bouriquetJ,;321

*Ces identifiants donnent accès à toutes les interfaces VokalBox*
...
- `utilisateurs_restaurant` - Comptes utilisateurs (login/password)
...
**Version :** 2.0 (avec credentials admin)
